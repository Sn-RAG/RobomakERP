                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <table class="table datatablem">
                                ...
                                <tbody>
                                <?php
                                $sorgu = $baglanti->query('SELECT Boya_Stok_ID,Marka,Renk,Seri,Kod,Uretim_T,Siparis_Miktar,Agirlik FROM view_siparis_boya WHERE Agirlik>Siparis_Miktar');
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body row g-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-floating">
                                                                        <input type="number"
                                                                               class="form-control focus KGirMiktar<?= $id ?>">
                                                                        <label>Miktar</label>
                                                            ...
                                                            <div class="card-footer">
                                                                <button type="button"
                                                                        class="btn btn-success form-control Kullan"
                                                                        BoyaStokID="<?= $id ?>">Kullan
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
