                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <table class="table datatablem">
                                ...
                                <tbody>
                                <?php
                                if (isset($_GET["Gecmis"])){$EiSor="Siparis_Miktar=0"; $StokSor=" AND Stok_Miktar=0";}
                                elseif (isset($_GET["Emanet-iade"])){$EiSor="iade_Miktar>0 OR Emanet_Miktar>0";}
                                else{$EiSor="Agirlik>Siparis_Miktar";$StokSor=" AND Stok_Miktar>0";}
                                ...
                                foreach ($sorgu as $sonuc) {
                                    ...
                                    if ($Siparis_Miktar < $sonuc['Agirlik'] || $Siparis_Miktar == 0) {
                                        ...
                                        foreach ($sorguS as $sonuc2) {
                                            ...
                                            foreach ($sorguT as $sonuc3) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($_GET["Emanet-iade"])){
                                                            echo $Siparis_Miktar > 0 ? "<span class='text-black-50'>Sipariş Bitmedi</span>" :($iade > 0 ? $iade."<span class='text-warning'> kg İADE</span>" : ($Emanet > 0 ? $Emanet."<span class='text-warning'> kg Emanet</span>" : ""));
                                                ...
                                                <div class="modal fade" id="Kullan<?= $id ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body row g-3">
                                                                <input type="hidden" class="KStokMiktar<?= $id ?>"
                                                                       value="<?= $Stok_Miktar > 0 ? $Stok_Miktar : 0 ?>"/>

                                                                <input type="hidden" class="K_Miktar<?= $id ?>"
                                                                       value="<?= $K_Miktar > 0 ? $K_Miktar : 0 ?>">

                                                                <div class="col-md-12">
                                                                    <div class="form-floating">
                                                                        <input type="number" class="form-control"
                                                                               value="<?= $sonuc['Kod'] ?>" disabled>
                                                                        <label>Kod</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-floating">
                                                                        <input type="date"
                                                                               class="form-control Kullanma_T<?= $id ?>"
                                                                               value="<?php
                                                                ...
                                                                <div class="text-center">
                                                                    <label class="form-check-label">
                                                                        <input class="form-check-input TumunuKullan"
                                                                               type="checkbox"
                                                                               BoyaStokID="<?= $id ?>">
                                                                        Tümünü Kullan
                                                                    </label>
