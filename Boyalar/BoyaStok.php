    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <a href="BoyaGelen.php" class="btn btn-outline-primary bi-strava me-3">&nbsp Sipariş Durumu</a>
                <a href="BoyaKullanilan.php" class="btn btn-outline-primary bi-tropical-storm">&nbsp BoyaKullan</a>
                <hr>
