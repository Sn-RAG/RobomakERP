                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_SESSION["Oturum"]) && $_SESSION["Oturum"] == "8388") {
                                        ...
                                        $goster = $baglanti->query("SELECT Kullanici_ID, Kadi, Yetki FROM kullanici WHERE Aktifmi= 1");
                                        foreach ($goster as $g) {
                                            if ($_COOKIE["Keksan"] == md5("Keksan" . $g["Kadi"] . "Keksan")) {
                                                $_SESSION["Kullanici"] = $g["Kadi"];
                                                $_SESSION["Oturum"] = "8388";
                                                $_SESSION["Yetki"] = $g["Yetki"];

                                                /*LOG KAYDI*/

                                                logtut($g["Kullanici_ID"], "Giriş Yaptı.");
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="index.php" method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="Kadi" value="<?= @$Kadi ?>" class="form-control" required>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="true" id="tik" name="Hatirla" checked>
                                    ...
                                    <?php
                                    if ($_POST) {
                                        $goster = $baglanti->prepare("SELECT Kullanici_ID, Sifre, Yetki FROM kullanici WHERE Kadi= ? AND Aktifmi= 1");
                                        ...
                                        if (md5("88" . $Sifre . "83") == $Snc["Sifre"]) {
                                            ...
                                            /*LOG KAYDI*/
                                            logtut($Snc["Kullanici_ID"], "Giriş Yaptı.");
                                            /*LOG KAYDI SON*/
