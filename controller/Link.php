...
$Link = $page != "Ana Sayfa" ?
    ...
    ($page == "Ürünler" || $page == "Ürün Tasarla" || $page == "Yeni Ürün" || $page == "Ürün Düzenle" || $page == "Levha Bilgisi Ekle" || $page == "Levha Bilgisi Düzenle" || $page == "Boya Bilgisi Ekle" || $page == "Boya Bilgisi Düzenle" || $page == "Ürün Levha Bilgisi" || $page == "Ürün Boya Bilgisi" ||
        $page == "Set Kontrol" || $page == "Preshane Üretim Formu" || $page == "Levha Hesabı" || $page == "Sipariş" || $page == "Sipariş Listesi" || $page == "Kulp Sipariş" || $page == "Kapak Sipariş" || $page == "Boya Sipariş" || $page == "Levha Sipariş" || $page == "Boya Siparişleri" || $page == "Kulp Siparişleri" || $page == "Levha Siparişleri" || $page == "Satış Yap" || $page == "Teklifler" ? "../../" : "../")
