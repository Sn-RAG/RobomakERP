...
$Link = $page != "Ana Sayfa"?
    ...
    $page == "Set Kontrol" || $page == "Sipariş" ||$page == "Sipariş Listesi" || $page == "Kulp Sipariş" || $page == "Kapak Sipariş" || $page == "Boya Sipariş" || $page == "Levha Sipariş" || $page == "Boya Siparişleri" || $page == "Kulp Siparişleri" || $page == "Levha Siparişleri" || $page == "Satış Yap" || $page == "Teklifler" ? "../../" : "../")
