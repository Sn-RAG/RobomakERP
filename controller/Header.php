...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item" <?= $SORBoya ?>>
            ...
            <ul id="Stok"
                class="nav-content collapse <?= $page == "Boya Stok" || $page == "Levha Stok" || $page == "Kapak Stok" || $page == "Kulp Stok"||$page == "Paket Stok" ? "show" : "" ?>"
        ...
        <li class="nav-item" <?= $SorFerhat ?>>
            ...
            <ul id="Uretim"
                class="nav-content collapse <?= $page == "Set Oluştur" || $page == "Devam eden" || $page == "Ürünler" || $page == "Ürün Boya Bilgisi" || $page == "Ürün Levha Bilgisi" ? "show" : "" ?>"
                data-bs-parent="#sidebar-nav">
                <li>
        ...
        <li class="nav-item" <?= $SORPazarlamaci ?>>
            ...
            <ul id="Pazarlama"
                class="nav-content collapse <?= $page == "Satış" || $page == "Konteynır Hesapla" || $page == "Maaliyet Düzenle" || $page == "Onay Gönder" || $page == "Teklif Hazırla" || $page == "Teklifler" ? "show" : "" ?>"
                data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?= $Link ?>Pazarlama/Teklifler/Teklifler.php"
                       class="<?= $page == "Teklifler" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Teklifler</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>Pazarlama/KonteynirHesapla.php"
                       class="<?= $page == "Konteynır Hesapla" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Konteynır Hesapla</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>Pazarlama/MaaliyetDuzenle.php"
                       class="<?= $page == "Maaliyet Düzenle" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Maaliyet Düzenle</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>Pazarlama/OnayGonder.php"
                       class="<?= $page == "Onay Gönder" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Onay için Gönder</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>Pazarlama/TeklifHazirla.php"
                       class="<?= $page == "Teklif Hazırla" ? "active" : "" ?>">
        ...
        <li class="nav-item" <?= $SORSatın_alma ?>>
            ...
            <ul id="SatinAlma"
                class="nav-content collapse <?= $page == "Sipariş" ||$page == "Sipariş Et"|| $page == "Çalışılan Firmalar" || $page == "Fiyat Teklifleri" || $page == "Gelen Sipariş Listesi"
                || $page == "Görüşülen Firmalar" || $page == "Operasyonlar" || $page == "Üretim İhtiyaçları" || $page == "Bekleyen Siparişler" || $page == "Verilen Siparişler" ? "show" : "" ?>"
                data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?= $Link ?>Navigasyon/SiparisEt.php"
                       class="<?= $page == "Sipariş"||$page == "Sipariş Et" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Sipariş</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/CalisilanFirmalar.php"
                       class="<?= $page == "Çalışılan Firmalar" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Çalışılan Firmalar</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/FiyatTeklifleri.php"
                       class="<?= $page == "Fiyat Teklifleri" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Fiyat Teklifleri</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/GelenSiparisListesi.php"
                       class="<?= $page == "Gelen Sipariş Listesi" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Gelen Sipariş Listesi</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/GorusulenFirmalar.php"
                       class="<?= $page == "Görüşülen Firmalar" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Görüşülen Firmalar</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/Operasyonlar.php"
                       class="<?= $page == "Operasyonlar" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Operasyonlar</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/UretimIhtiyaclari.php"
                       class="<?= $page == "Üretim İhtiyaçları" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Üretim İhtiyaçları</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/BekleyenSiparisler.php"
                       class="<?= $page == "Bekleyen Siparişler" ? "active" : "" ?>">
                        <i class="bi bi-circle"></i></i><span>Bekleyen Siparişler</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $Link ?>SatinAlma/VerilenSiparisler.php"
                       class="<?= $page == "Verilen Siparişler" ? "active" : "" ?>">
