                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body row g-3">
                                                    ...
                                                    <button type="submit" class="btn btn-warning form-control KapakDuzenle" KapakID="<?= $id ?>">Düzenle</button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body row g-3">
                ...
                <button id="YeniKapak" type="button" class="btn btn-primary form-control">Ekle</button>
            </div>
        </div>
    </div>
</div>
