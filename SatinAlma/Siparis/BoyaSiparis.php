                        ...
                        <table class="table datatablem">
                            <thead>
                                <tr class="table-light">
                                    <th>#</th>
                                    <th><button type="button" class="btn btn-success bi-check-lg form-control BoyaSec">&nbsp Seç</button></th>
                                    <th>Marka</th>
                                    <th>Renk</th>
                                    <th>Seri</th>
                                    <th>Kod</th>
                                                ...
                                                <div class="modal-body row g-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-floating">
                                                            <input type="text" id="Marka<?= $id ?>" value="<?= $Marka ?>" class="form-control">
                                                            <label>* Marka</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            <input type="text" id="Kod<?= $id ?>" value="<?= $Kod ?>" class="form-control">
                                                            <label>* Kod</label>
                                                        </div>
                                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body row g-3">
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" id="Renk" class="form-control temizle" required>
                        <label>* Renk</label>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <button type="button" id="BoyaEkle" class="btn btn-primary form-control">
                    Ekle
                </button>
            </div>
        </div>
...
if (isset($_POST["BoyaSec"])) {
    $_SESSION["Boyalar"] = $_POST["BoyaSec"];
}
?>