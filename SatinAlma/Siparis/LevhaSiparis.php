...
?>
                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="../../Navigasyon/SiparisEt.php" class="btn btn-secondary  bi-arrow-left-circle"> Geri Dön
                                </a>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#YeniLevha"><i
                            ...
                            <table class="table datatablem">
                                ...
                                <tbody>
                                <?php
                                $sorgu = $baglanti->query('SELECT * FROM levha');
                                foreach ($sorgu as $sonuc) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $Kalinlik ?></td>
                                        <td>
                                            <button type="button" class="btn btn-outline-primary bi-cart4"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#Siparis<?= $id ?>"> Sipariş
                                            </button>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body row g-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-floating">
                                                            <input type="text"
                                                                   value="<?= $Kalinlik ?>"
                                                                   class="form-control Kalinlik<?= $id ?>" readonly>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-floating">
                                                            <input type="text"
                                                                   value="<?= $Cap ?>"
                                                                   class="form-control Cap<?= $id ?>" readonly>
                                                            <label>* Çap</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-floating">
                                                            <input type="text"
                                                                   class="form-control focus temizle Adet" id="Adet<?= $id ?>" LevhaID="<?= $id ?>">
                                                            <label>* Adet</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="card-footer">
                                                    <button type="button"
                                                            class="btn btn-primary form-control LevhaSiparis"
                                                            LevhaID="<?= $id ?>">
                                                        Sipariş Et
                                                    </button>
                                                </div>
    ...
    <div class="modal fade" id="YeniLevha" tabindex="-1"
         aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            <select id="Firma" class="form-select">
                                <option value=""></option>
                                <?php
                                $query = $baglanti->query("SELECT Firma_ID, Firma FROM firmalar")->fetchAll();
                                foreach ($query as $s) {
                ...
                <div class="card-footer">
                    <button type="button" id="LevhaEkle"
