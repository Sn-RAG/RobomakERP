...
<div class="modal fade" id="YeniBoya" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Yeni Kulp Ekle</h5>
                <button type="button" class="btn-close"
                        data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="post" class="modal-body needs-validation row g-3" novalidate>
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type='text' name='TFirma' class='form-control' id="TFirma">
                        <label>Tedarik Edilen Firma</label>
                    </div>
                </div>

                <div class="col-md-12">
                    <div class="form-floating">
                        <input type='text' name='KulpAdi' class='form-control'>
                        <label>Kulp Adı</label>
                    </div>
                </div>

                <div class="col-md-12">
                    <div class="form-floating">
                        <input type='text' name='Cesit' class='form-control'>
                        <label>Çeşidi</label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="number" name="KulpRenk" class="form-control" required>
                        <label>Rengi</label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="number" name="Adet" class="form-control" id="Adet" required>
                        <label>Adeti</label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="date" name="S_Tarihi" class="form-control" value="<?php
                ...
                <button type="submit" id="KulpEkle" class="btn btn-primary form-control">Ekle</button>
        </form>
    </div>
</div>
<?php
