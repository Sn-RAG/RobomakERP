                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $S_Tarihi ?></td>
                                        <td>
                                            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#SecSil<?= $id ?>"><i class="bi bi-x-square"></i>
                                            </button>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="BoyaSiparisleri.php?Boya_Siparis_Sil=<?= $id ?>&Boya_Stok_ID=<?= $Boya_Stok_ID ?>&Siparis_ID=<?= $Siparis_ID ?>">
                                                        <button type="button" class="btn btn-outline-danger form-control">Sipariş Sil
                                                        </button>
                                                    </a>
                                                </div>
                                            </div>
