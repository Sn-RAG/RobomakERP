        ...
        <section class="section">
            <div class="row py-5">
                ...
                <a href="admin/index.php"
                   style="border: 0 solid #ffffff00;display: flex;background-color: #4300c9;color: white;border-color: #ffffff00;height: 124px;margin-right: 15px; justify-content: center;align-items: center;flex-direction: column-reverse;flex-wrap: nowrap;align-content: stretch;">
                    Yönet
