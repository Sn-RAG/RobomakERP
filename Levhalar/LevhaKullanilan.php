...
?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body row g-3">
                                                            ...
                                                            <input type="hidden" class="StokAgirlik<?= $id ?>"
                                                                   value="<?= $Stok_Agirlik > 0 ? $Stok_Agirlik : 0 ?>"/>

                                                            <input type="hidden" class="StokAdet<?= $id ?>"
                                                                   value="<?= $Stok_Adet > 0 ? $Stok_Adet : 0 ?>"/>
                                                            <input type="hidden" class="KAdet<?= $id ?>"
                                                                   value="<?= $K_Adet > 0 ? $K_Adet : 0 ?>"/>
                                                            <input type="hidden" class="KAgirlik<?= $id ?>"
                                                                   value="<?= $K_Agirlik > 0 ? $K_Agirlik : 0 ?>"/>
                                                        </div>
                                                        <div class="card-footer">
                                                            <button type="button" class="btn btn-primary form-control Kullan"
                                                                    levhastokid="<?= $id ?>">Kullan
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        $('.datatablem').DataTable({
            ...
            responsive: true,
            columnDefs: [
                {"visible": false, "targets": [0,1,5,6,8]},
