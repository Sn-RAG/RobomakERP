    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <a href="LevhaGelen.php" class="btn btn-outline-primary bi-strava me-3">&nbsp Sipariş Durumu</a>
                <a href="LevhaKullanilan.php" class="btn btn-outline-primary bi-tropical-storm">&nbsp LevhaKullan</a>
                <hr>
