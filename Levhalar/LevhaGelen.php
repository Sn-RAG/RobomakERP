                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body row g-3">
                                                        ...
                                                        <input type="hidden" class="SipAgirlik<?= $id ?>" value="<?= $Siparis_Agirlik > 0 ? $Siparis_Agirlik : 0 ?>" />

                                                        <input type="hidden" class="SipAdet<?= $id ?>" value="<?= $Siparis_Adet > 0 ? $Siparis_Adet : 0 ?>" />

                                                        <input type="hidden" class="Stok_Agirlik<?= $id ?>" value="<?= $Stok_Agirlik > 0 ? $Stok_Agirlik : 0 ?>" />
                                                        <input type="hidden" class="Stok_Adet<?= $id ?>" value="<?= $Stok_Adet > 0 ? $Stok_Adet : 0 ?>" />
                                                    </div>
